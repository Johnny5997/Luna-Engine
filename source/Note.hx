...
class Note extends FlxSprite
{
	...
	private var CharactersWith3D:Array<String> = ["bambi-3d", 'bambi-unfair', 'lunafinal', 'luna3d', 'lunatrueform', 'lunadoll', 'lunagod', 'bf3d', 'noahreal', 'holyluna', 'lunaclamorous', 'lunaseptuagint', 'sisters', 'philtrixpissed'];
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?musthit:Bool = true, noteStyle:String = "normal", inCharter:Bool = false, guitarSection:Bool = false)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'vs-luna-free-trial':
				notePathLol = 'notes/OMGtop10awesomehi';
			case 'heart-of-gold':
				notePathLol = 'notes/goldnotes';
			case 'tessattack':
				notePathLol = 'notes/tessattacknotes';
			case 'lost':
				notePathLol = 'notes/halloweennotes';
			case 'galactic':
				notePathLol = 'notes/spectrenotes';
			case 'milky-way':
				notePathLol = 'notes/spectrenotes';
			case 'master':
				notePathLol = 'notes/spectrenotes';
