...
{
    // Wavy Background with same color
    bg = new FlxSprite(-500, -300).loadGraphic(Paths.image('backgrounds/void/mainmenubgkeybinds', 'shared'));
    bg.color = 0xFFea71fd;  // keep your menu color
    bg.scrollFactor.set();
